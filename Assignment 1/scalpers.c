...
/* Since our input is organized into two arrays, the first contains all the dates the PS5 sales start
	 and the second the dates when the sales end, we assign 3 variables in order to keep track of the earliest
